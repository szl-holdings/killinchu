...
# Wave 15 frontier organs (Dynamic Linear Attention, Context-Ready Transformer, OPERA perplexity-reward, Formula-Graph Brain).
COPY szl_dla.py szl_ctxready.py szl_opera.py szl_fgbrain.py ./
