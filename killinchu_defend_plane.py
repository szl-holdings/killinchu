...
.kc-plane-tabs .kc-unavailable{flex:0 0 auto;display:inline-flex;align-items:center;min-height:38px;padding:8px 11px;color:#9dabb9}
...
""".encode("utf-8")
# Missing pages remain visibly unavailable, not links to an unrelated surface.
_TABS = r"""<nav class="kc-plane-tabs" data-killinchu-plane-tabs="v1" aria-label="Killinchu capability planes"><a class="kc-product" href="/resilience">Killinchu</a><a href="/defend">Defend</a><span class="kc-unavailable" data-unavailable-route="/immune">Immune · migration pending</span><a href="/elite/maritime">Maritime</a><a href="/elite#cuas_lab">Airspace</a><span class="kc-unavailable" data-unavailable-route="/khipu">Evidence page · unavailable</span><span class="kc-state">One public runtime</span></nav>""".encode("utf-8")
...
<style>
.kc-plane-tabs .kc-unavailable{flex:0 0 auto;display:inline-flex;align-items:center;min-height:40px;padding:8px 11px;color:#9dabb9}
...
<body>
<nav class="kc-plane-tabs" data-killinchu-plane-tabs="v1" aria-label="Killinchu capability planes"><a class="kc-product" href="/resilience">Killinchu</a><a href="/defend" aria-current="page">Defend</a><span class="kc-unavailable" data-unavailable-route="/immune">Immune · migration pending</span><a href="/elite/maritime">Maritime</a><a href="/elite#cuas_lab">Airspace</a><span class="kc-unavailable" data-unavailable-route="/khipu">Evidence page · unavailable</span><span class="kc-state">One public runtime</span></nav>
<main class="shell">
