/* ngraph.events @ anvaka/ngraph.events (BSD-3-Clause) © Andrei Kashcha. Vendored 0-CDN; ESM source wrapped as UMD global `ngraphEvents`. */
(function(root,factory){if(typeof module==='object'&&module.exports){module.exports=factory();}else if(typeof define==='function'&&define.amd){define([],factory);}else{root.ngraphEvents=factory();}}(typeof self!=='undefined'?self:this,function(){
