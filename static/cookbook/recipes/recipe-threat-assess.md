# Score a target via Sentra integration (dual-use check)

**Recipe ID:** `recipe-threat-assess`  
**Tags:** threat, sentra, dual-use, classification  
**Doctrine v11 — 749/14/163**  
**Maintained by:** Yachay <yachay@szlholdings.dev>  
*Co-Authored-By: Perplexity Computer Agent*

## Intent
Assess a detected airframe against the Sentra security gate: classify side, run a dual-use check, and return a threat score + recommended posture (sense/evidence only).

## Steps
1. POST /api/killinchu/v2/threat/assess with {model or signature, telemetry}.
2. Sentra returns {side: adversary|dual-use|allied, threat_score, dual_use_flag}.
