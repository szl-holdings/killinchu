...
_SRC = {
    ...
    "nvd":         ("NVD CVE API 2.0 (NIST)", "https://services.nvd.nist.gov/rest/json/cves/2.0", "feed", "Rate-limited; treat as CACHED at volume. NIST is the CVSS/CVE authority."),
    "epss":        ("FIRST EPSS API (Exploit Prediction Scoring System)", "https://api.first.org/data/v1/epss", "feed", "FIRST.org exploit-probability scores; pairs with CISA KEV for CVE prioritisation."),
    "mitre_attack": ("MITRE ATT&CK Enterprise (STIX)", "https://raw.githubusercontent.com/mitre-attack/attack-stix-data/master/enterprise-attack/enterprise-attack.json", "feed", "MITRE adversary tactics/techniques knowledge base (official STIX bundle)."),
    "mitre_site":  ("MITRE ATT&CK", "https://attack.mitre.org/", "knowledge", "MITRE ATT&CK matrix — adversary technique reference."),
    "nist_800207": ("NIST SP 800-207 Zero Trust Architecture", "https://csrc.nist.gov/pubs/sp/800/207/final", "standard", "NIST canonical zero-trust standard."),
...
_TAB = {
    ...
    "darkgraph":    ["adsb_mil", "kev_mirror", "mitre_attack", "arx_sc1", "arx_mar1"],
    ...
    "attack_surface":  ["arx_k8s", "arx_zt1", "kev_mirror", "mitre_attack"],
    ...
    # T-K1 Threat/CVE/Cyber-Defense tabs — each grounded in ≥1 real cited leader feed
    "cve_watch":          ["nvd", "kev_mirror", "epss", "arx_epss"],
    "cve_gate_impact":    ["nvd", "kev_mirror", "epss", "slsa_dev"],
    "attack":             ["mitre_attack", "mitre_site", "kev_mirror", "arx_sc1"],
    "adversary_techniques": ["mitre_attack", "mitre_site", "kev_mirror", "arx_sc1"],
    "signed_incidents":   ["cosign", "in_toto", "slsa_dev", "kev_mirror"],
    "threat_intelligence": ["kev_mirror", "nvd", "epss", "mitre_attack", "arx_sc1"],
    "feed_liveness":      ["kev_mirror", "nvd", "epss", "mitre_attack", "adsb_mil", "usgs_quake"],
    "threats":      ["kev_mirror", "nvd", "mitre_attack", "arx_sc1"],
...
_KW = [
    ...
    (("kev", "cve", "advisor", "threat", "sanction", "osint", "darkhunt", "vuln", "exploit", "epss", "liveness"), ["kev_mirror", "nvd", "epss", "mitre_attack", "arx_epss"]),
    (("attack", "adversar", "mitre", "technique", "tactic", "ttp"), ["mitre_attack", "mitre_site", "kev_mirror", "arx_sc1"]),
